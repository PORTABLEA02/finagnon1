...
import { calculateAge, formatDateForDisplay, formatDateTimeForDisplay } from '../../utils/dateUtils';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{formatDateForDisplay(patient.date_of_birth)}</p>
                </div>
                <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{formatDateTimeForDisplay(patient.created_at)}</p>
                </div>
              </div>
            </div>
          </div>
