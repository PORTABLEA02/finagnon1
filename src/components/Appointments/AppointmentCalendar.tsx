...
import { formatDateForDatabase, getCurrentDateString, formatDateForDisplay, isToday } from '../../utils/dateUtils';
...
export function AppointmentCalendar() {
  ...
  const handleDateClick = (date: Date) => {
    setSelectedDate(formatDateForDatabase(date));
  };
    ...
    <div className="space-y-6">
        ...
        <div className="p-6 border-b border-gray-200">
          ...
          <div className="grid grid-cols-7 gap-1">
            ...
            {days.map((day, index) => {
              ...
              const isSelected = formatDateForDatabase(day) === selectedDate;
              ...
              return (
                ...
                >
                  <div className={`text-sm font-medium mb-1 ${
                    isTodayDate ? 'text-yellow-600' : 'text-gray-900'
                  }`}>
                    {day.getDate()}
                  </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-800">
              Rendez-vous du {formatDateForDisplay(selectedDate)}
            </h3>
