...
import { formatDateForDatabase, getCurrentDateString } from '../../utils/dateUtils';
...
export function ConsultationForm({ consultation, onClose, onSave }: ConsultationFormProps) {
  const [formData, setFormData] = useState({
    ...
    date: consultation?.date || getCurrentDateString(),
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Convertir la date au bon format pour la base de données
    const processedData = {
      ...formData,
